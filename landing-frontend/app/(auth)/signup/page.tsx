...
export default function SignUpPage() {
    ...
    return (
        <div className="flex-1 flex items-center justify-center px-4">
            <div className="w-full max-w-md py-8 px-6 backdrop-blur-xs  rounded-2xl shadow-2xl">
                {/* Header */}
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="flex flex-row gap-4 w-full items-center">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <div className="relative">
                                <User className="absolute left-3 top-3 h-5 w-5 text-black pointer-events-none" />
                                <Input
                                    type="text"
                                    placeholder="Username"
                                    disabled={registerMutation.isLoading}
                                    className="pl-10 border-black text-black placeholder:text-black w-full"
                        ...
                        <div className="w-40 space-y-1">
                            ...
                            >
                                <SelectTrigger className="border-black text-black w-full">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                placeholder="••••••••"
                                disabled={registerMutation.isLoading}
                                className="pl-10 pr-10 border-black text-black placeholder:text-black"

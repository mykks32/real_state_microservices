        ...
        <div className="min-h-screen p-8 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="bg-transparent shadow-lg border-slate-500/20">
                    ...
                    <CardContent className="space-y-1">
                        <p><span className="font-medium">Created At:</span> {new Date(user.createdAt).toLocaleString()}
                        </p>
                        {user.lastLoginAt && (
                            <p><span
                                className="font-medium">Last Login:</span> {new Date(user.lastLoginAt).toLocaleString()}
                            </p>
                        )}
                    </CardContent>
                </Card>
